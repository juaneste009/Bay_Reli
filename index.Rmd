...
x <- rexp(1000, 2)
plot(density(x), main = '', xlab = 't', ylab = 'f(t)', xlim = c(0.1, 5))
````
...
y <- rexp(1000, 2)
z <- rexp(1000, 0.5)
plot(density(y), main = '', xlab = 't', ylab = 'f(t)', xlim = c(0.1, 3), lty = 1)
lines(density(z), lty = 2)
legend('topright', legend = c('Distribución apriori', 'Distribución aposteriori'), lty = 2:1)
````
